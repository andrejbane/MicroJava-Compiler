...
public class AbstractClassHeaderRecoveredExtends extends AbstractClassHeader {

    private String name;
    private ExtendsRecovery ExtendsRecovery;

    public AbstractClassHeaderRecoveredExtends (String name, ExtendsRecovery ExtendsRecovery) {
        this.name=name;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AbstractClassHeaderRecoveredExtends(\n");
