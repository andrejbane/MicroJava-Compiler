...
public class FormalParametersPresent extends FormalParametersOpt {

    private FormalParameters FormalParameters;

    public FormalParametersPresent (FormalParameters FormalParameters) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParametersPresent(\n");
