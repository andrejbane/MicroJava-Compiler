...
public class MethodDeclarationsMultiple extends MethodDeclarationList {

    private MethodDeclarationList MethodDeclarationList;
    private MethodDeclaration MethodDeclaration;

    public MethodDeclarationsMultiple (MethodDeclarationList MethodDeclarationList, MethodDeclaration MethodDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclarationsMultiple(\n");
