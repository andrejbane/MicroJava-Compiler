...
public class AbstractClassConcreteMethod extends AbstractClassMember {

    private MethodDeclaration MethodDeclaration;

    public AbstractClassConcreteMethod (MethodDeclaration MethodDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AbstractClassConcreteMethod(\n");
