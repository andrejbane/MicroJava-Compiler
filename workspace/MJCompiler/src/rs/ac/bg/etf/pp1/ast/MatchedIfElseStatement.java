...
public class MatchedIfElseStatement extends MatchedStatement {

    private IfCondition IfCondition;
    private MatchedStatement MatchedStatement;
    private MatchedStatement MatchedStatement1;

    public MatchedIfElseStatement (IfCondition IfCondition, MatchedStatement MatchedStatement, MatchedStatement MatchedStatement1) {
