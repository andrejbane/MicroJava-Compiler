...
public class ValidVariableDeclaration extends VariableDeclaration {

    private Type Type;
    private VariableDeclaratorList VariableDeclaratorList;

    public ValidVariableDeclaration (Type Type, VariableDeclaratorList VariableDeclaratorList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ValidVariableDeclaration(\n");
