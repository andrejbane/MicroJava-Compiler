...
public class GlobalDeclarationsMultiple extends GlobalDeclarationList {

    private GlobalDeclarationList GlobalDeclarationList;
    private GlobalDeclaration GlobalDeclaration;

    public GlobalDeclarationsMultiple (GlobalDeclarationList GlobalDeclarationList, GlobalDeclaration GlobalDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalDeclarationsMultiple(\n");
