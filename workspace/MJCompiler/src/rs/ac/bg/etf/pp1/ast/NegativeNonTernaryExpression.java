...
public class NegativeNonTernaryExpression extends NonTernaryExpression {

    private Term Term;
    private AdditiveTail AdditiveTail;

    public NegativeNonTernaryExpression (Term Term, AdditiveTail AdditiveTail) {
        this.Term=Term;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NegativeNonTernaryExpression(\n");
