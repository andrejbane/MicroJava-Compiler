...
public class FormalParametersSingle extends FormalParameters {

    private FormalParameter FormalParameter;

    public FormalParametersSingle (FormalParameter FormalParameter) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParametersSingle(\n");
